...
<head>
    ...
    <link rel="stylesheet" href="/client/style/note-home-tiles.css">
    <script src="/server/script/note-home-tiles.js" defer></script>
                ...
                <div class="left-nav1">
                    ...
                    <button class="tooltip">
                        <span class="material-symbols-outlined">
                            <a href="/client/php/note-home-list.php">list</a>
                            </span>
